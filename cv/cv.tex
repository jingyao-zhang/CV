    ...
    \resumeSubheading
      ...
      {External Developer}{Aug 2023 \textbf{--} Present}
        \resumeItemListStart
            ...
            \resumeItem{Designed and developed a \textit{Combined Attestation} framework for \textit{CoCo KBS} to support GPU attestation. [\href{https://github.com/jingyao-zhang/demo-combined-attestation}{repo}]
