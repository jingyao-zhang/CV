...
\section{Talks}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        \begin{enumerate}
        \item \textbf{Jingyao Zhang}. ``In-SRAM Computing for Cryptography." \textit{In Xia Peisu Forum hosted by ICT. \emph{[\href{https://jingyao-zhang.github.io/slides/XiaPeisu.pdf}{slides}]}
        \hfill Dec 2023} \vspace{-2pt}
