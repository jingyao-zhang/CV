...
\section{Services}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        \textbf{\large Reviewed Papers:} {\large 3}\hfill \\ \vspace{3pt}
    
        \textbf{Journal Paper Review}, IEEE Computer Architecture Letters (CAL)\hfill \textit{Sep, Aug, Jun 2023} \\ \vspace{5pt}
