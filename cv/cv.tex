    ...
    \resumeSubheading
      ...
      {External Developer}{Aug 2023 \textbf{--} Present}
        \resumeItemListStart
            ...
            \resumeItem{Designed and developed a \textit{Combined Attestation} framework for \textit{CoCo KBS} to support GPU attestation.}
...
\section{Services}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        \textbf{\large Reviewed Papers:} {\large 4}\hfill \\ \vspace{3pt}
    
        \textbf{Journal Paper Review}, IEEE Computer Architecture Letters (CAL)\hfill \textit{2023} \\ \vspace{5pt}

        \textbf{\large Evaluated Artifacts:} {\large 11}\hfill \\ \vspace{3pt}

        \textbf{Artifact Evaluation Board}, Journal of Systems Research (JSys)\hfill \textit{2023} \\ \vspace{3pt}

        \textbf{Artifact Evaluation Committee}, ACM European Conference on Computer Systems (EuroSys)\hfill \textit{2024} \\ \vspace{3pt}

        \textbf{Artifact Evaluation Committee}, Annual Network and Distributed System Security Symposium (NDSS)\hfill \textit{2024} \\ \vspace{3pt}
